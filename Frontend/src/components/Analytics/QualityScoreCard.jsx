...
import {
    LuCircleCheck, LuClock, LuLayoutDashboard, LuAlignLeft, LuBot, LuStar,
        ...
        <div className={styles.qualitySection}>
            ...
            <div className={styles.metricsGrid}>
                ...
                <MetricCard
                    ...
                    score={factors?.aiEffectiveness?.score}
                    maxScore={15}
                    details={factors?.aiEffectiveness?.details}
                    warnings={factors?.aiEffectiveness?.warnings}
                />
                <MetricCard
                    icon={LuStar}
                    title="User Feedback"
