...
import { LuBox, LuUser, LuCalendar, LuSearch, LuPlus, LuTrash2, LuSettings, LuUsers } from 'react-icons/lu';
      ...
      {workspaces.length === 0 ? (
        <div className={styles.emptyState}>
          ...
          <button className={styles.createButton} onClick={handleCreateClick} style={{ marginTop: '1rem' }}>
            <LuPlus size={16} style={{ marginRight: '8px' }} />
                  ...
                  <div className={styles.headerRight}>
                    ...
                    {workspace.current_user_role === 'owner' && (
                      <div className={styles.headerIconActions}>
                        ...
                        <button
                          className={styles.iconAction}
                          onClick={(e) => { e.stopPropagation(); navigate(`/workspaces/${workspace.id}/settings`); }}
