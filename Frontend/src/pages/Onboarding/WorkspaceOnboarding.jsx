...
import { useAuth } from '../../contexts/AuthContext'; // Import useAuth to access user data if needed? Actually WorkspaceService is usually enough
...
const WorkspaceOnboarding = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            await WorkspaceService.create({ name: workspaceName });
            ...
            <div className={styles.card}>
                ...
                <form onSubmit={handleSubmit} className={styles.form}>
                    ...
                    <div className={styles.actions}>
                        ...
                        <button type="button" onClick={handleSkip} className={styles.skipButton} disabled={isLoading}>
                            Skip for now
                        </button>
                    </div>
                </form>
